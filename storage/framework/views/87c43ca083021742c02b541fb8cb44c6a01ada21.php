...
<body>
  <div class="container">
    ...
    <?php $__currentLoopData = $groupedByAuthor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $authorName => $posts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="table-responsive col-lg-9 mb-5">
      <h3>Kreator: <?php echo e($authorName); ?></h3>
...
<?php /**PATH D:\JOURNEY RFP\Associate - IFS - Application Development_PwC Indonesia\UPLOAD GitHub\ltpsm1\resources\views/dashboard/posts/pdf.blade.php ENDPATH**/ ?>