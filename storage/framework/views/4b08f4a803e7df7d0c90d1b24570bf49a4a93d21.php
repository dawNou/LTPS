...
<?php $__env->startSection('title', 'Buat Pertanyaan Baru'); ?>
...
unset($__errorArgs, $__bag); ?>" id="soal" name="soal" required autofocus value="<?php echo e(old('soal')); ?>">
    ...
    <div class="mb-3">
      ...
      <select class="form-select" name="katprod_id">
        <?php $__currentLoopData = $katprods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $katprod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if(old('katprod_id') == $katprod->katprod_id): ?>
            <option value="<?php echo e($katprod->katprod_id); ?>" selected><?php echo e($katprod->namakatprod); ?>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KULIAH\8. SEMESTER 8\BISMILLAH REVISI PROGRAM\RevProgM7\ltpsm1\resources\views/dashboard/pertanyaans/create.blade.php ENDPATH**/ ?>