...
return [
    ...
    */
    ...
    'boolean' => '* :attribute harus bernilai benar (1) atau salah (0).',
    ...
    'email' => '* :attribute harus merupakan alamat yang valid.',
    ...
    'min' => [
        'numeric' => '* :attribute harus terdiri dari minimal :min.',
        'file' => '* :attribute harus terdiri dari minimal :min kilobytes.',
        'string' => '* :attribute harus terdiri dari minimal :min karakter.',
        'array' => '* :attribute harus terdiri dari minimal :min items.',
    ],
