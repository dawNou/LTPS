  ...
  <table class="table table-striped table-sm">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="text-align: center;">{{ $produk->nama_produk ?? 'Tidak ada nama produk'}} </td>
        <td style="text-align: center;">{{ $produk->katprod->namakatprod ?? 'Tidak ada kategori produk' }}</td>
        <td style="text-align: center;">

          {{-- read --}}
          <a href="/dashboard/produks/{{ $produk->slug }}" class="badge bg-info">
            <i class="bi bi-eye"></i>
          </a>

          {{-- update --}}
          <a href="/dashboard/produks/{{ $produk->slug }}/edit" class="badge bg-warning">
